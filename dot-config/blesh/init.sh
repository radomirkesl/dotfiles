...
ble-face -s syntax_error              bg=red,fg=231
...
ble-face -s command_function          fg=blue # fg=133
...
function blerc/vim-load-hook {
  ...
  #ble-bind -m vi_nmap -f 'C-c' discard-line
    ble-bind -m vi_nmap -f up 'history-search-backward'
    ble-bind -m vi_nmap -f down 'history-search-forward'
    ble-bind -m vi_nmap -f k 'history-search-backward'
    ble-bind -m vi_nmap -f j 'history-search-forward'

    # ble-bind -m vi_imap -f 'C-k' ''
    # ble-bind -m vi_imap -f 'C-j' ''
    #
    # ble-bind -m vi_imap -f 'C-k' 'history-search-backward'
    # ble-bind -m vi_imap -f 'C-j' 'history-search-forward'
